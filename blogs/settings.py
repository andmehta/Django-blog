...
SECRET_KEY = "django-insecure-l6!m!5%1u(dv)itl@*u7ydrbzj+@a4e=f$^#5_(0-ye8s%4q*6"
...
# NOTE: Normally I'd do all the configs as env variables, but since this is just a POC, I'll just pass in the password
DB_PASS_FILE = os.getenv("DB_PASS_FILE", "secrets/password.txt")
